...
#pragma alloc_text(PAGE, MyPreReadFile)
#endif
...
{
	DbgPrintEx(DPFLTR_IHVDRIVER_ID, 0, "filter unload\n");
...
FLT_PREOP_CALLBACK_STATUS MyPreReadFile(
...
)
{
	...
	FltCloseClientPort(F_data.pFilter, &F_data.pIocpClientPort);
